...
require("../utils/stream_events.cjs");
...
var ChatOpenAICompletions = class extends require_base.BaseChatOpenAI {
	...
	*/
	async *_streamChatModelEvents(messages, options, _runManager) {
		...
		yield* (0, _langchain_core_language_models_openai_completions_stream.convertOpenAICompletionsStream)(abortableStream(streamIterable, options.signal), {
