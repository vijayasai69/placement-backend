 ...
 * ```
 */
declare function messagesDeltaReducer(state: BaseMessage[], writes: Messages[]): BaseMessage[];
//#endregion
export { Messages, REMOVE_ALL_MESSAGES, messagesDeltaReducer, messagesStateReducer };
