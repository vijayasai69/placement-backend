...
exports.notificationAgent = exports.NotificationAgent = void 0;
const email_provider_js_1 = require("../../providers/email.provider.js");
const logger_js_1 = require("../../utils/logger.js");
class NotificationAgent {
    async sendJobMatchAlert(data) {
        logger_js_1.logger.info(`NotificationAgent preparing email alert for user: ${data.email} regarding job: ${data.jobTitle}`);
    ...
    `;
        return (0, email_provider_js_1.sendEmail)({
            to: data.email,
            subject,
            html: htmlContent,
        });
    ...
    async sendDeadlineReminder(data) {
        logger_js_1.logger.info(`NotificationAgent preparing deadline reminder for user: ${data.email}`);
        const formattedDeadline = data.applicationDeadline.toLocaleDateString("en-US", {
            weekday: "long",
            year: "numeric",
            month: "long",
...
exports.notificationAgent = new NotificationAgent();
exports.default = exports.notificationAgent;
